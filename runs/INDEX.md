...
**Błąd N_eff (93):** kanoniczny estymator potrafi zapaść t_neff do ~0,4 — naprawa i audyt dawnych „nierozstrzygniętych” czekają na decyzję użytkownika.
...
93. **ML NA RANKINGU MONET: UCZCIWY, ALE MAŁO CZUŁY (AU2 kroki 1–2, 2026-09-25).** Pełny pipeline (10 cech + nośnik,
    ...
    zaniża pewność (fałszywe „nierozstrzygnięte”, nigdy fałszywe „pozytywne”); naprawa + audyt dawnych werdyktów —
    decyzja użytkownika.
