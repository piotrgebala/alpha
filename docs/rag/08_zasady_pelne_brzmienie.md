...
# Zasady CLAS-5 — pełne brzmienie z uzasadnieniami i historią (archiwum)

> Ten plik to **dosłowna kopia `CLAUDE.md` z 2026-09-24** (commit f7640eb), zrobiona przy jego
> odchudzeniu (runda porządkowa na gałęzi `metodyka-kontrole`, wskazówka AI_devs: „mniej reguł
> w instrukcji, bez historii i statusu”). **Obowiązuje krótka wersja w `CLAUDE.md`** — numeracja
> zasad 1–20 jest ta sama. Tu zostają uzasadnienia, przykłady z rund, sprostowania i szczegóły
> konfiguracji, które z instrukcji wyleciały. Przy sporze o znaczenie zasady: krótka wersja
> mówi CO, ten plik mówi DLACZEGO.

## (kopia) CLAS-5 — Instrukcje projektowe (Claude Code)
